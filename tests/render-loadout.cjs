...
const names=['project_x','project_y','map_clip_polygon','map_draw_polygon','draw_ground_tile','is_path','map_draw_spawn_platform','map_draw_base_platform','diamond','draw_defender','draw_wanderer','draw_triage','draw_singularity','draw_vigil_icon','draw_singularity_icon','ui_panel_y','ui_draw_rich_text','ui_control_rect','ui_draw_button','ui_stat_breakdown','ui_draw_surface'];
const drawApi=new Function('s',`with(s){${source};return {${names.join(',')}};}`)(h);Object.assign(h,drawApi);
h.obj_game.tower_catalog.singularity.draw_model=h.draw_singularity;h.obj_game.tower_catalog.triage.draw_model=h.draw_triage;h.obj_game.tower_catalog.vestral.draw_model=h.draw_defender;h.obj_game.tower_catalog.wanderer.draw_model=h.draw_wanderer;
...
const gravity=h.obj_game.tower_catalog.singularity;
Object.assign(h.obj_game.selected_tower,{definition:gravity,damage:gravity.damage,hit_points:150,display_hit_points:150,max_hit_points:150,move_speed:gravity.move_speed,attack_interval:gravity.attack_interval,attack_range:gravity.attack_range,charge_duration:gravity.charge_duration,charge_reuse_delay:gravity.charge_reuse_delay,debris:[{},{},{}],density:4,ability_tab:3});
h.obj_game.loadout.cards=[2,2,1,1,1,1];h.obj_game.loadout.fan_hover=[0,0,0,0,0,1];h.obj_game.loadout.selected=5;
render('.build/loadout-singularity-review.png');
